...
class Flyghotell extends CI_Controller {

	/**
	 * Controller for the "Flyg och Hotell".
	 *
	 * This controller contains all functions needed to make a flight and hotel booking combined.
	 *
	 * 
	 *
...
/* End of file flyghotell.php */
/* Location: ./application/controllers/flyghotell.php */